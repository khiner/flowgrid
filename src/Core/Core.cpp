...
void String::Set(TransientStore &s, std::string_view value) const { s.Set(Id, std::string(value)); }
...
void CoreActionHandler::Apply(TransientStore &s, const ActionType &action) const {
    std::visit(
        Match{
            /* Primitives */
