...
// the slash's buttons in path can be used to quickly select parallel directories
...
//  sleep time in milliseconds to apply in the thread loop, when no datas to extract
//  the sleep time can be ssen just after the opening of a directory who contain pictures
...
// see strftime function <ctime> for customize
