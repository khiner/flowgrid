...
struct TextBufferImpl {
    TextBufferImpl(std::string_view text = "", LanguageID language_id = LanguageID::None);
    TextBufferImpl(const fs::path &);
    ~TextBufferImpl();
    ...
    void SetPalette(TextBufferPaletteIdT);
