...
JsonType(FlowGridStyle, Colors, FlashDurationSec,
    ...
    ParamsHeaderTitles, ParamsStretchRowHeight, ParamsMinVerticalItemHeight, ParamsAlignmentHorizontal, ParamsAlignmentVertical, ParamsTableFlags, ParamsTableSizingPolicy)
