...
public:
    ...
    virtual void rect(double x, double y, double l, double h, const string &color, const string &link) = 0;
    virtual void triangle(double x, double y, double l, double h, const string &color, int orientation, const string &link) = 0;
    ...
    virtual void text(double x, double y, const char *name, const string &link) = 0;
    virtual void label(double x, double y, const char *name) = 0;
    virtual void dot(double x, double y, int orientation) = 0;
    virtual void Error(const char *message, const char *reason, int nb_error, double x, double y, double width) = 0;
};
