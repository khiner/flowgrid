...
bool Knob(const char *label, float *p_value, float v_min, float v_max, float speed = 0, const char *format = nullptr,
          KnobVariant variant = KnobVariant_Tick, float size = 0, KnobFlags flags = KnobFlags_None, int steps = 10);
